...
for (const filepath of [leafletOptions, debug]) {
  ...
  const LABEL = process.env.OSRM_LABEL || 'Truck'
  ...
  const MAPBOX_TOKEN = process.env.OSRM_MAPBOX_TOKEN || 'pk.eyJ1IjoibHZ4IiwiYSI6ImNsbHFiNGF0bzBlbm8zb256cDRmMW11eGMifQ.FHZFXaWvfgCAo08gitmxyQ'
